...
for image_path in images:
    ...
    # Put the sum on the image
    # Draw black stroke around text
    cv2.putText(image, f'Sum: {currency_sum} DT', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 4, cv2.LINE_AA)
    # Draw white text
    cv2.putText(image, f'Sum: {currency_sum} DT', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
...
# python image.py --modeldir ./ --graph detect.tflite --labels labelmap.txt --threshold 0.5 --imagedir images --save_results
